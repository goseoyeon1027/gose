import { ShoppingCart, Menu, X, Trash2, Star, Plus, Minus, CreditCard, CheckCircle2, XCircle, AlertCircle, LogOut } from "lucide-react";
          ...
          <nav className="hidden items-center gap-8 md:flex">
            {navLinks.map((link) => (
              <motion.a
                ...
                whileHover={{ y: -2 }}
                onClick={(e) => {
                  if (link.name === "상품" && link.href === "#products") {
                    e.preventDefault();
                    // 홈으로 이동
                    navigate("/");
